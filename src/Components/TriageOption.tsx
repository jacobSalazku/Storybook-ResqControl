...
const TriageOption = () => {
    ...
    return (
        <div className="flex w-2/3 flex-row justify-between px-4">
            <Button
                label="T1"
                backgroundColor={selectedTriage === "T1" ? "bg-light-blue text-white" : "bg-white"}
                size="w-14"
                variant="rounded"
            ...
            <Button
                label="T2"
                backgroundColor={selectedTriage === "T2" ? "bg-light-blue text-white" : "bg-white"}
                size="w-14"
                variant="rounded"
            ...
            <Button
                label="T3"
                backgroundColor={selectedTriage === "T3" ? "bg-light-blue text-white" : "bg-white"}
                size="w-14"
                variant="rounded"
